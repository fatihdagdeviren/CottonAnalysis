...
"""
#TODO: Modul tam olarak tamamlanmadi. Tamamlanacak.
# Ornek : https://github.com/deeplearningturkiye/pratik-derin-ogrenme-uygulamalari/blob/master/KERAS/nesne_tanima_CNN_CIFAR10.py
class MyDLM():
    ...
    def CreateModel1(self):
        ...
        model.add(Dense(self.num_classes))  # num_classes = 10
        ...
        if not self.data_augmentation:
            ...
            model.fit_generator(datagen.flow(x_train, y_train,
                                             batch_size=self.batch_size),
                                steps_per_epoch=int(np.ceil(x_train.shape[0] / float(self.batch_size))),
                                epochs=self.epochs,
                                validation_data=(x_test, y_test),
                                workers=4)
